<?php
	...
	include_once("../../../app/banco/controlador/Controller_listas.php");
    ...
    <div id="contenido">
		...
		<!-- InstanceBeginEditable name="cuerpo" -->
		  ...
		  <div align="center" id="formulario">
        	<div align="center" class="frmTitulo"><h2>Pagos Procesados</h2></div>
            	...
            	<strong><form name="frmFiltro"  id="frmFiltro">
                    ...
                    <table>
                        <tr align="left" class="coloRowP">
                            ...
                            <td><input type="button" onclick="listByFilterProcesados()" value="Filtrar" /></td>
                            <td><input type="reset"  value="Limpiar" /></td>
                        </tr>
                    </table>               
                </form></strong>
               <form method="post" name="frmPago"  action="../../../app/pago/vista/Procesado.php">
